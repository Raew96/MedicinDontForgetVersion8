...
import kotlinx.android.synthetic.main.fragment_monthly_statistics.disease_linearlayout
import kotlinx.android.synthetic.main.fragment_monthly_statistics.medicines_linearlayout
import kotlinx.android.synthetic.main.fragment_monthly_statistics.tv_avg_mood_value
import kotlinx.android.synthetic.main.fragment_monthly_statistics.tv_avg_sleep_value
...
class MonthlyStatisticsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        diseasesFromBase.medicineWithHistory.forEach {
            ...
            customView2.setCap(it.name, it.history.joinToString (separator = "\n"){ sdf2.format(it) })
